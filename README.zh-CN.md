...
- 🛰 **11 家原生集成** —— Claude Code、Codex(即你 ChatGPT 套餐里的 Codex 额度)、GLM、OpenCode Go、Kimi、Antigravity、Grok,以及 DeepSeek、OpenRouter、AIHubMix、OrcaRouter 的按量付费余额。直连各家 HTTP 接口,不 shell-out 到社区工具。GitHub Copilot 在路线图上。
